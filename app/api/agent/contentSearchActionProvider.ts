...
const SearchContentSchema = z.object({
  query: z
    .string()
    .describe(
      "Search query or topic to find content (e.g., 'bitcoin', 'x402 protocol', 'blockchain payments')",
    ),
});
 ...
 *
 * @returns Array of custom actions for content search and stats
 */
  ...
  return customActionProvider([
    {
      name: "search_content",
      description:
        "Search for monetized content by topic or keywords. Returns content metadata including rootHash, txHash, summary, and payment details. Use this to find content that users have uploaded and monetized.",
    ...
    },
    {
      ...
      description:
        "Download and retrieve the full content from 0G Storage using a rootHash. Use this after finding content with search_content to get the actual blog post or article content.",
    ...
    },
    {
      ...
      description:
        "Get statistics about all monetized content including total content count, total earnings, and unique creators. Use this to show overall platform metrics.",
